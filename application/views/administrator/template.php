...
<head>
  ...
  <meta name="author" content="polsub.ac.id">
  <!-- Font Awesome Icons -->
...
<div class="wrapper">
  ...
  <footer class="main-footer text-sm">
    <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a target='_BLANK' href="https://www.mycoding.net/"><?php echo $iden['nama_website']; ?></a>.</strong>
    All rights reserved.

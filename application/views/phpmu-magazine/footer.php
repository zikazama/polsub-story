...
echo "<div class='wrapper'>
	...
	echo "</ul>
	<p>&copy; ".date('Y')."<b>Sistem Informasi Polsub Story</b><br/>Develop by. <b style='color:orange'>Group 1</b> Project 2. <b style='color:orange'>Politeknik Negeri subang</b></p>
</div>";
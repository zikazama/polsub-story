							...
							<div class="column12">
								...
								<form action="<?php echo base_url(); ?>kontributor/pendaftaran" method="POST" enctype='multipart/form-data' onSubmit="return validasireg(this)">
									<p class="contact-form-user">
										<label for="c_name">NIP/NIK/NIM<span class="required">*</span></label>
										<input type="text" placeholder="NIP/NIK/NIM" name='aa' style='width:40%' id="c_name" onkeyup="nospaces(this)" required/>
									</p>
									<p class="contact-form-user">
									...
									<p class="contact-form-user">
										<label for="c_name">Jurusan<span class="required">*</span></label>
										<select name="ef">
											<option>-- Jurusan --</option>
											<option>Sistem Informasi</option>
											<option>Teknik Perawatan dan Perbaikan Mesin</option>
